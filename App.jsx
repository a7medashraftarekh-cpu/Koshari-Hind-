...
const menu = [
  ...
  {n:"بيتزا ايطالي زنجر (Small)",c:"بيتزا ايطالي",p:100,i:"https://kimi-web-img.moonshot.cn/img/www.shutterstock.com/abd27cf09237e609aa5cd702b44e7bc85d697a1f.jpg"},
  {n:"بيتزا ايطالي زنجر (Medium)",c:"بيتزا ايطالي",p:130,i:"https://kimi-web-img.moonshot.cn/img/www.shutterstock.com/abd27cf09237e609aa5cd702b44e7bc85d697a1f.jpg"},
  {n:"بيتزا ايطالي زنجر (Large)",c:"بيتزا ايطالي",p:165,i:"https://kimi-web-img.moonshot.cn/img/www.shutterstock.com/abd27cf09237e609aa5cd702b44e7bc85d697a1f.jpg"},
...
export default function App() {
  ...
  const cats = [
    ...
    ["صاروخ ايطالي","🚀"],["بيتزا ايطالي","🍕"],["نجرسكو","🍝"],["الحواوشي","🥪"],["الفراخ المشويه","🍗"],
    ["كريب لحوم","🌯"],["كريب بطاطس وجبن","🧀"],["كريب فراخ","🍗"],["كريب حلو","🍫"],
    ["حلو هند","🍮"],["اضافات هند","🥗"],["اضافات الصاروخ","➕"]
  ];

  const filterButtons = ["الكل","كشري","بيتزا شرقي","الطواجن","وجبات سوري","صاروخ ايطالي","بيتزا ايطالي","نجرسكو","الحواوشي","الفراخ المشويه","كريب لحوم","كريب بطاطس وجبن","كريب فراخ","كريب حلو","حلو هند","اضافات هند","اضافات الصاروخ"];
              ...
              cart.map((c, i) => (
                <div className="cart-line" key={`${c.item.n}-${i}`}>
                  <div style={{display:'flex',alignItems:'center',gap:'10px'}}>
                    {c.item.i && <img src={c.item.i} className="cart-thumb" alt="" width="50" height="50" onError={(e) => { e.target.style.display='none'; }} />}
                    <div>
                      <b>{c.item.n}</b>
